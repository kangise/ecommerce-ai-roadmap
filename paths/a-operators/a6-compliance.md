...
> 完整的标准化模板（含验证状态、贡献者信息、分享链接）存放在 [prompts/compliance.md](../../prompts/compliance.md)。
...
[完整模板 → prompts/compliance.md](../../prompts/compliance.md#模板-1-多市场合规对比)
...
[< A5 库存](a5-inventory.md) | [Path 总览](README.md) | [A7 视觉 >](a7-visual-content.md)
