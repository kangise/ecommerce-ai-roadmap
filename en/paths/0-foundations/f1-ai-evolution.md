...
> ⚠️ **Security Reminder**: The more powerful an Agent is, the greater the security risk. OpenClaw runs on your system with access to your files and applications. Make sure you understand the permission settings and don't give the Agent excessive privileges.
