[🇨🇳 中文](../../paths/d-platforms/platform-comparison.md) | 🇺🇸 English
...
3. [AI Application Focus Comparison](#3-ai-application-focus-comparison)
4. [Platform Selection Decision Framework](#4-platform-selection-decision-framework)
5. [Commission & Fee Comparison](#5-commission--fee-comparison)
6. [Logistics Comparison](#6-logistics-comparison)
7. [Advertising System Comparison](#7-advertising-system-comparison)
8. [Multi-Platform Expansion Roadmap](#8-multi-platform-expansion-roadmap)
...
| Platform | Biggest Difference from Amazon | AI Focus |
|----------|-------------------------------|----------|
...
| **eBay** | Auction + Fixed Price + Best Offer; strong in pre-owned/collectibles; AI Magical Listing | Pre-owned condition descriptions, pricing strategy AI, Magical Listing |
| **Coupang** | Same-day/next-day delivery standard; Korean language mandatory; KC certification | Korean Listing optimization, KC certification analysis |
| **Faire** | B2B wholesale; 15% new customer / 0% repeat; brand story focus | Brand story AI, wholesale pricing models, retailer relationship management |
| **Otto/Zalando** | Strict compliance (CE/EPR/VAT/GPSR); German language mandatory; high return rates | German Listing optimization, compliance checklist AI |

---

## 3. AI Application Focus Comparison

### 3.1 AI Application Maturity by Platform
...
### 3.2 Top 3 AI Application Scenarios per Platform

| Platform | #1 AI Scenario | #2 AI Scenario | #3 AI Scenario |
|----------|---------------|---------------|---------------|
| Amazon | Listing SEO (COSMO/Rufus optimization) | Search term report AI analysis | Bulk review analysis |
| Shopify | Meta/Google Ads creative AI generation | Email personalization (Klaviyo AI) | GEO optimization (AI search engine recommendations) |
| TikTok Shop | Short video script batch generation | Influencer screening and matching | Livestream script AI generation |
| Walmart | Amazon→Walmart Listing conversion | First-price bidding optimization | Buy Box price monitoring |
| Temu | Product selection data analysis | Supply chain cost optimization | Product image AI optimization |
| Shopee/Lazada | Multi-language Listing localization (6 languages) | Livestream script generation | Campaign promotion strategy planning |
...
| eBay | Pre-owned condition description AI generation | Pricing strategy AI analysis | Magical Listing usage |
| Coupang | Korean Listing optimization | KC certification needs analysis | Search ad optimization |
| Faire | Brand story AI generation | Wholesale pricing model | Retailer relationship management |
| Otto/Zalando | German Listing optimization | European compliance checklist AI generation | Return rate management |

### 3.3 Reusing Amazon AI Skills Across Platforms

How much of what you learned in Path A can be directly reused on other platforms?

| Path A Skill | Direct Reuse | Needs Adaptation | Completely Different |
|-------------|-------------|-----------------|---------------------|
| A1 Product Research | Walmart/eBay/Shopee | Temu (different selection logic) | Faire (B2B selection) |
| A2 Listing Optimization | Walmart (different format) | Shopee/Rakuten/Coupang (language) | TikTok (video-first) |
| A3 Ad Optimization | Walmart Connect | Shopee Ads/Mercado Ads | TikTok Ads/Meta Ads (different logic) |
| A4 Customer Service | Walmart/eBay | Shopee (multi-language) | WhatsApp (conversational) |
...
### 4.2 Choose by Category

| Category | Best Platforms (Besides Amazon) | Reason |
|----------|-------------------------------|--------|
| Consumer Electronics | Walmart → Shopify → Coupang | Walmart low competition, Shopify brand premium, Coupang Korean market |
| Home & Furniture | Walmart → Pinterest → Faire | Walmart lower commission (10% vs 15%), Pinterest high purchase intent, Faire B2B |
| Fashion & Apparel | TikTok Shop → Shopee → Zalando | TikTok content-driven, Shopee SEA, Zalando European fashion |
| Beauty & Personal Care | TikTok Shop → Xiaohongshu → Shopee | Best categories for social seeding |
| Sports & Outdoors | Walmart → YouTube → eBay | Walmart lower commission, YouTube reviews, eBay pre-owned market |
| Pet Supplies | Walmart → Shopee → Faire | High-repurchase category, multi-channel risk diversification |
| Food | Shopify → Faire → Mercado Libre | DTC high margins, Faire wholesale, LatAm fast growth |
| Auto Parts | eBay → Walmart | eBay strong in auto parts, Walmart omnichannel |
| Collectibles/Pre-Owned | eBay | eBay's unique advantage (auction + authentication) |
| Low-Price Commodities | Temu → AliExpress | Supply chain-driven, no brand needed |

### 4.3 Choose by Market

| Target Market | Recommended Platforms | Priority |
|--------------|----------------------|----------|
| US | Amazon → Walmart → Shopify → TikTok Shop | Largest market, multi-platform layout |
| Europe (Germany) | Amazon.de → Otto → Zalando | High compliance threshold but large market |
| Europe (Southern) | Amazon → AliExpress | AliExpress strong in Spain/France |
| Japan | Amazon.co.jp → Rakuten | Dual-platform coverage of Japan |
| Korea | Coupang | Absolute dominant player in Korea |
| Southeast Asia | Shopee → Lazada → TikTok Shop | Three-platform coverage of SEA |
| Latin America | Mercado Libre | The only choice for LatAm |
| Global (B2B) | Faire + Alibaba.com | B2B wholesale channels |

---

## 5. Commission & Fee Comparison

| Platform | Commission | Monthly Fee | Logistics | Ads | Other Fees |
|----------|-----------|-------------|-----------|-----|------------|
| Amazon | 8-15% | $39.99/mo | FBA fees | PPC | Storage/long-term storage |
| Shopify | 0% (payment 2.9%) | From $39/mo | Self-arranged | Meta/Google Ads | App subscriptions |
| TikTok Shop | 2-8% | Free | Platform logistics | TikTok Ads | Influencer commissions |
...
| Shopee | 1-6% + 2% processing | Free | SLS logistics | Shopee Ads | Some event fees |
| Mercado Libre | Varies by category/country | Free | Mercado Envios | Mercado Ads | Installment fees |
| Rakuten | 2-7% | ¥19,500-100,000/mo | Seller arranges | RPP ads | System usage fee |
| eBay | Varies by category | $0-$350/mo | Seller arranges/GSP | Promoted Listings | None |
| Coupang | Varies by category | Free | Rocket Delivery | Search ads | KC certification |
| Faire | 15% new / 0% repeat | Free | Seller arranges | Promoted Listings | $10/new customer |
...
## 7. Advertising System Comparison
