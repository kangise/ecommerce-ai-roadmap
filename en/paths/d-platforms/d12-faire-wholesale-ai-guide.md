[🇨🇳 中文](../../paths/d-platforms/d12-faire-wholesale-ai-guide.md) | 🇺🇸 English
...
| Order Volume | Bulk (MOQ) | Single units |
| Pricing | Wholesale price (40-50% of retail) | Retail price |
| Relationship | Long-term partnership | One-time transaction |
| Commission | 15% (new customers) / 0% (repeat customers) | 8-15% |
| Returns | 60-day free returns (Faire covers) | 30 days |

### 1.2 Products Suited for Faire

- Products with brand stories (independent retailers value brands)
- Design-forward products (home, gifts, beauty, food)
- Products with sufficient margins (wholesale price needs to be 40-50% of retail)
- Not suited: Pure commodities, low-price products, unbranded products

## 2. AI Application Scenarios

### 2.1 Faire Algorithm & Ranking Mechanism

Faire's search algorithm determines which brands retailers see. Based on operational experience ([Smoothed.io](https://www.smoothed.io/blog/faire-account-settings-that-drive-sales)):
...
### 2.2 Faire Account Settings Optimization (High-Leverage Moves)

Based on [Smoothed.io](https://www.smoothed.io/blog/faire-account-settings-that-drive-sales) operational data, these setting adjustments can significantly boost exposure:
...
Collections are Faire's on-site search SEO. Create two types:
...
Every uncreated Collection = a search result where you can't be found.

**Tiered Promotions (Always-On)**

| Tier | Offer | Purpose |
|------|-------|---------|
| Reach average order value | Free shipping | Push orders to target amount |
| Higher amount | 10% off + free shipping | Push larger orders |
| $1000-2000+ | 20% off | Attract bulk buyers |
| Pre-order products | 5% off | Collect orders early |
...
Faire's ad system is CPC-based. Based on operational data ([Smoothed.io](https://www.smoothed.io/blog/faire-account-settings-that-drive-sales)): $570 ad spend generated $1,979 in first-order sales (3.5x ROAS), not including subsequent repeat purchases from those retailers.
...
| Repeat Customer Commission | 0% | Retailers purchasing again (through Faire platform) |
| Faire Direct Commission | 0% | Retailers you bring yourself (through your unique link) |
...
Faire's business model core: 15% commission on new customers, 0% on repeat customers. This means your long-term profit depends on repeat purchase rate.

## 3. Faire Strategic Analysis & AI Applications

> **Real Case: Faire's Business Strategy**
> Faire's core strategy is "start extremely narrow, then expand with data." The platform builds a sourcing layer rather than a sales layer, and embedded finance (Net 60 payment terms) is the glue rather than the product itself ([Faster Than Normal](https://fasterthannormal.co/businesses/faire)). This means success on Faire requires understanding retailer purchasing psychology, not consumer buying psychology.
...
|----------|---------------|------|
| Brand Story | AI generates brand narratives that resonate with retailers | ChatGPT/Claude |
| Product Descriptions | AI generates B2B-style product descriptions (emphasizing margins and display effects) | ChatGPT/Claude |
| Pricing Strategy | AI calculates wholesale/suggested retail/margin | ChatGPT + Excel |
| Retailer Communication | AI generates personalized retailer outreach and follow-up emails | ChatGPT/Claude |
| Product Images | AI generates product images suitable for wholesale display (including merchandising mockups) | Midjourney/DALL-E |
| Market Analysis | AI analyzes category trends and competitors on Faire | ChatGPT + Faire data |

## 4. Completion Checklist

- [ ] Evaluate whether products are suited for Faire
- [ ] Complete brand page and product listing
