[🇨🇳 中文](../../paths/d-platforms/d5-temu-seller-guide.md) | 🇺🇸 English
...
3. [Limited AI Applications in Temu Operations](#3-limited-ai-applications-in-temu-operations)
...
|--------|------|------------|
| GMV | $90-95B (targeting $100B) | 24% share of Amazon's cross-border GMV |
| Cross-Border Market Share | 24% (on par with Amazon) | Only 1% in 2022, 24x growth in 3 years |
| Market Coverage | 90+ countries | Fastest global expansion in history |
| MAU | 246 million | 3rd globally among e-commerce apps (behind Amazon, Shopee) |
| Growth Rate | From $0.29B in 2022 → $70.8B GMV in 2024 | 4,500x growth |
...
### 1.2 Fully Managed vs Semi-Managed Model

| Dimension | Fully Managed | Semi-Managed |
|-----------|---------------|--------------|
| Pricing Control | Temu sets price (seller provides supply price, Temu decides retail price) | Seller sets price (Temu provides suggested price, seller can adjust) |
| Logistics | Seller ships to Temu domestic warehouse → Temu handles cross-border shipping | Seller ships to overseas warehouse → Local delivery |
| Operations | Temu handles Listing creation, main image design, marketing | Seller handles Listing, images, pricing |
| Profit Margin | Extremely low (Temu pushes price near cost) | Relatively higher (seller controls pricing) |
| Delivery Time | 7-15 days (cross-border direct mail) | 2-5 days (local warehouse shipping) |
| Returns | Temu handles | Seller handles |
| Best For | Factory-type sellers, suppliers with cost advantages | Brand sellers with overseas warehouses, existing cross-border sellers |
| Entry Threshold | Lower (just need products) | Higher (requires overseas warehouse capability) |
...
### 1.4 Temu Commission and Fee Structure

| Fee Item | Fully Managed | Semi-Managed |
|----------|---------------|--------------|
| Commission | 0% (Temu profits from price spread) | 2-5% (varies by category) |
| Logistics | Included in supply price | Seller bears (overseas warehouse → buyer) |
| Return Cost | Temu bears | Seller bears |
| Ad Fees | None (no on-site ads) | None |
| Storage Fees | None (just ship to Temu warehouse) | Overseas warehouse storage (third-party) |

---

## 2. Onboarding Decision Framework

### 2.1 Categories Suited for Temu (Detailed Analysis)
...
| Category | Reason Not Suited | Alternative Platform |
|----------|-------------------|---------------------|
| Branded Electronics (Insta360, UGREEN) | Brand premium destroyed by platform price pressure | Amazon + Shopify |
| High-Ticket Products (>$50) | Temu users have low AOV, poor conversion | Amazon + Walmart |
| Products Requiring After-Sales Support | Temu's after-sales system is weak | Amazon (FBA after-sales) |
| Differentiated/Innovative Products | Temu users won't pay premium for innovation | Shopify + Social Media |
| Products Needing Brand Storytelling | Temu has no brand display space | Shopify + Instagram |
| Large/Heavy Items | High logistics cost, Temu subsidies don't make sense | Amazon + Walmart |

### 2.3 AI-Assisted Onboarding Decision (Enhanced)
...
## 3. Limited AI Applications in Temu Operations
...
Temu has strict main image requirements, and the platform allocates traffic based on image quality:

| Image Requirement | Fully Managed | Semi-Managed |
|-------------------|---------------|--------------|
| Main Image | Temu team shoots/designs | Seller provides, must meet standards |
| White Background | Required | Required |
| Lifestyle Images | Temu may create independently | Seller provides |
...
| Monitor Item | Frequency | Tool | AI Application |
|-------------|-----------|------|----------------|
| Competitor pricing | Daily | Manual/scraper | AI analyzes price trends, predicts price wars |
...
| Category popularity | Monthly | Temu bestseller lists | AI analyzes category trends, guides product selection |
| Platform policies | Real-time | Temu seller announcements | Monitor policy changes and business impact |
...
- You can develop simplified/basic versions specifically for Temu
- Temu's low prices should not affect Amazon's brand positioning
```
...
- [ ] Complete Temu onboarding decision assessment
- [ ] If joining: Choose managed model and list products
- [ ] If not joining: Develop strategy to counter Temu competition
