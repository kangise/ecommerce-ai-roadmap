...
5. [Instagram Shopping In-Depth Practice](#5-instagram-shopping-in-depth-practice)
6. [Meta Advantage+ AI Advertising In-Depth Guide](#6-meta-advantage-ai-advertising-in-depth-guide)
...
> If you're already doing TikTok (see [D2 TikTok Shop Guide](../d-platforms/tiktok-shop-ai-guide.md)), this section helps you understand Instagram's differentiated positioning.
...
|----------|---------------|---------|
| **Instagram** | Lifestyle scene | Summer outdoor picnic, model elegantly wearing it, with lo-fi music, text: "Summer essential" |
...
> **Key insight**: The same product material can be reused, but the script and editing style must adapt to the platform. AI can help you automatically generate three platform variants from one core script (see [E7 Cross-Channel Coordination](e7-social-media-cross-channel.md)).

---

## 3. Reels AI Content-Creation Methodology

> **Related reading**: [D2 TikTok Shop](../d-platforms/tiktok-shop-ai-guide.md) — the TikTok short-video methodology is referenced in D2; the same material can adapt to different platform styles.
...
> **Related reading**: [D1 Shopify](../d-platforms/shopify-ai-guide.md) — Instagram Shopping deeply integrates with Shopify; Product Catalog sync and DTC strategy are referenced in D1.
...
1. **Creative material is the only lever**: The only thing you can control in ASC is the creative. Provide 10-20 different-angle materials for AI to test
2. **Budget suggestion**: Daily budget ≥ $50 (below this, AI doesn't have enough learning data)
3. **Existing Customer Budget Cap**: Set 10-20% to avoid AI only serving existing customers
4. **Pixel data must be sufficient**: At least 50 purchase events/week for ASC to learn effectively
5. **Don't adjust frequently**: Give AI at least a 7-day learning period
...
> **Related reading**: [E3 Xiaohongshu](e3-xiaohongshu-ai-guide.md) — the creator-collaboration (KOL/KOC) methodology for the Chinese market is referenced in E3 Xiaohongshu; the creator-screening models can inform each other.
...
> **Next step**: After completing E1, it's recommended to continue with [E2 YouTube AI Operations](e2-youtube-ai-guide.md) to expand your video-content capability from short video to long video. Or jump directly to [E7 Cross-Channel Coordination](e7-social-media-cross-channel.md) to learn how to efficiently reuse Instagram content on other platforms.
