...
1. [プロンプトから Agent へ](#1-プロンプトから-agent-へai-能力の-4-つのレベル) · 2. [自動化の 3 層モデル](#2-自動化の-3-層モデル) · 3. [MCP プロトコル詳解](#3-mcp-プロトコル詳解) · 4. [Agent フレームワーク全景](#4-agent-フレームワーク全景) · 5. [10 の EC Agent シーン](#5-10-の越境ec-agent-シーン) · 6. [セキュリティとリスク](#6-セキュリティとリスク) · 7. [実装ロードマップ](#7-実装ロードマップ) · 8. [学習リソース](#8-学習リソース) · 9. [完了チェック](#9-完了チェック)
...
|------|---------------|---------------------|
| **モデル能力** | GPT-4 が出たばかり、推論は限定的 | GPT-4o/Claude Opus 4 で推論が大幅向上 |
