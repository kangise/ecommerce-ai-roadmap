...
1. [なぜプロンプトが重要か](#1-なぜプロンプトが重要か) · 2. [CRISP フレームワーク](#2-crisp-フレームワーク構造化プロンプトの方法論) · 3. [6 つの上級テクニック](#3-6-つの上級プロンプトテクニック) · 4. [シーン別テンプレート集](#4-越境ec-シーン別プロンプトテンプレート集20) · 5. [よくある失敗と直し方](#5-よくある失敗と直し方) · 6. [上級: Context Engineering](#6-上級prompt-engineering-から-context-engineering-へ) · 7. [学習リソース](#7-学習リソース)


## このモジュールで身につくこと

プロンプトはあなたと AI をつなぐ唯一のインターフェースです。同じ AI モデルでも、プロンプトの良し悪しで出力品質は 10 倍変わります。
...
| モデル | プロンプトの好み | 注意点 |
|--------|------------------|--------|
| ChatGPT (GPT-4o) | どんな形式も受け付け、自然文への反応が良い | 長いプロンプトが有効。背景をたっぷり与えられる |
...
## 6. 上級: Prompt Engineering から Context Engineering へ

> **関連**: [D6 東南アジア AI ガイド](../d-platforms/d6-southeast-asia-ai-guide.md) 多言語プロンプトの応用は D6 へ

### 6.1 2026 年のトレンド: Context Engineering
