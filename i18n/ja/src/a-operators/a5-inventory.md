...
1. [在庫の方法論](#1-在庫の方法論ai-の前に理解すべき基礎) · 2. [AI ツール全景](#2-ai-ツール全景在庫管理段階で何を使うか) · 3. [プロンプトテンプレート集](#3-プロンプトテンプレート集在庫専用) · 4. [在庫実践ワークフロー](#4-在庫実践ワークフロー) · 5. [よくある罠](#5-よくある在庫の罠) · 6. [上級テクニック](#6-上級テクニック) · 7. [学習リソース](#7-学習リソース)
...
| ツール | 用途 | リンク |
|--------|------|--------|
| ChatGPT / Claude | 補充計算、安全在庫分析、大型セール備蓄戦略、IPI 改善案 | [chat.openai.com](https://chat.openai.com/) / [claude.ai](https://claude.ai/) |
