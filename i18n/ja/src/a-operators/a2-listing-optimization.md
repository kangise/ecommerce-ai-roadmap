...
1. [Listing の方法論](#1-listing-の方法論ai-の前に理解すべき基礎) · 2. [AI ツール全景](#2-ai-ツール全景listing-段階で何を使うか) · 3. [プロンプトテンプレート集](#3-プロンプトテンプレート集listing-専用) · 4. [Listing 実践ワークフロー](#4-listing-実践ワークフロー) · 5. [よくある罠](#5-よくある-listing-の罠) · 6. [上級テクニック](#6-上級テクニック) · 7. [学習リソース](#7-学習リソース)
...
**Rufus AI ショッピングアシスタント([§6.1](#61-amazon-rufus-最適化2026-新トレンド)参照):**
...
| ツール | 用途 | リンク |
|--------|------|--------|
| ChatGPT / Claude | Listing 一式生成、競合分析、多言語ローカライズ、A+ コピー | [chat.openai.com](https://chat.openai.com/) / [claude.ai](https://claude.ai/) |
...
```
あなたは Amazon [US/DE/JP] 市場に精通した Listing 専門家です。

商品情報:
- 商品名: [名前]
- コア訴求点: [訴求点1]、[訴求点2]、[訴求点3]
- ターゲット顧客: [ペルソナ]
- コアキーワード(Helium 10 より): [検索量付きキーワードリスト]
- 競合との差別化: [自社商品の独自性]

[ターゲット市場] に適した Listing を生成してください:
1. タイトル(200 文字以内、最初の 80 文字に最高検索量のキーワード)
...
**なぜこのプロンプトが必要か:** A+ Content(Enhanced Brand Content)は転換率を 3〜10% 高められる(Amazon 公式データ)。しかし多くのセラーの A+ Content は箇条書きの内容を画像付きで繰り返すだけ。良い A+ Content はブランドストーリーを語り、利用シーンを見せ、比較図で説得すべきです。
...
### 6.1 Amazon Rufus 最適化(2026 新トレンド)
...
### 6.3 Listing ローカライズの文化差(US vs DE vs JP)
...
| Rufus 最適化 | Rufus 最適化 | [6.1](#61-amazon-rufus-最適化2026-新トレンド) |
| GEO 最適化 | GEO 最適化 | [6.2](#62-生成エンジン最適化geoaio) |
| 文化適応 | 文化適応 | [6.3](#63-listing-ローカライズの文化差us-vs-de-vs-jp) |
