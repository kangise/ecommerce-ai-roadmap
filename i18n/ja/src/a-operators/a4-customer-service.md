...
1. [CS の方法論](#1-cs-の方法論ai-の前に理解すべき基礎) · 2. [AI ツール全景](#2-ai-ツール全景cs-段階で何を使うか) · 3. [プロンプトテンプレート集](#3-プロンプトテンプレート集cs-専用) · 4. [CS 実践ワークフロー](#4-cs-実践ワークフロー) · 5. [よくある罠](#5-よくある-cs-の罠) · 6. [上級テクニック](#6-上級テクニック) · 7. [学習リソース](#7-学習リソース)
...
| ツール | 用途 | リンク |
|--------|------|--------|
| ChatGPT / Claude | 返信テンプレート生成、低評価分析、異議申し立て作成、多言語翻訳 | [chat.openai.com](https://chat.openai.com/) / [claude.ai](https://claude.ai/) |
