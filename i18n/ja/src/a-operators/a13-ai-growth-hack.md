...
<セルフチェック>
① 依頼の 8 項目（あなたは EC 転換率最適化の専門家です。…）がすべて存在し、番号と順序が依頼どおり。欠落・余分なし。 <!-- ref: amazon.bullet_point.count -->
...
<セルフチェック>
① 依頼の 8 項目（あなたは多言語 EC ローカライゼーションの専門家です。…）がすべて存在し、番号と順序が依頼どおり。欠落・余分なし。 <!-- ref: amazon.bullet_point.count -->
