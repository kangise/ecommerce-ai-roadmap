...
1. [TikTok Shop vs Amazon vs Shopify](#1-tiktok-shop-vs-amazon-vs-shopify) · 2. [ショート動画コンテンツ制作](#2-ai-ショート動画コンテンツ制作) · 3. [インフルエンサー協働とマッチング](#3-インフルエンサー協働と-ai-マッチング) · 4. [ライブコマース](#4-ライブコマースと-ai) · 5. [商品最適化](#5-商品ページと-seo-最適化) · 6. [広告投下](#6-tiktok-ads-ai-最適化) · 7. [データ分析](#7-データ分析と運営最適化) · 8. [Prompt テンプレート](#8-prompt-テンプレートtiktok-shop-専用) · 9. [AI ツール全景](#9-ai-ツール全景) · 10. [よくある落とし穴](#10-よくある落とし穴) · 11. [ケーススタディ](#11-ケーススタディ)
...
TikTok の商品カードは動画の下と検索結果に出る。白背景画像は TikTok のフィードで広告のように見え、クリック率が低い。生活シーン画像はコンテンツのように見え、クリック率が 2-3 倍高い。
...
40%+ の Z 世代ユーザーが Google ではなく TikTok を優先して製品を検索する。TikTok 検索と Google 検索の核心的違い:
...
TikTok Shop の手数料(5-8%)は Amazon(15%+FBA)よりはるかに低い。だが単純に TikTok でより安く売れない:
