---
name: ecom-pricing
description: Set competitive prices and model profitability. Use for Buy Box pricing analysis, profit margin calculation, breakeven analysis, or multi-marketplace pricing strategy.
---
...
- [Competitor Price Analysis](assets/templates/template-1-competitor-price-analysis.md)
- [Pricing Strategy Recommendation](assets/templates/template-2-pricing-strategy-recommendation.md)
- [Promotion ROI Calculation](assets/templates/template-3-promotion-roi-calculation.md)
