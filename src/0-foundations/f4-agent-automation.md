...
- 深入理解 MCP 协议的架构和应用
- 了解主流 Agent 框架（LangGraph、CrewAI、OpenClaw）
...
| **框架成熟** | LangChain 早期，bug 多 | LangGraph/CrewAI/OpenClaw 生产可用 |
...
| [OpenClaw](https://github.com/openclaw/openclaw) | 个人 AI Agent | 日常任务自动化 | 低-中 | 180K+ |
...
### 4.5 OpenClaw：个人 AI 助理

OpenClaw 是 2025 年底发布的现象级开源项目，定位是"运行在你自己设备上的个人 AI Agent"。
...
| [OpenClaw 官方文档](https://docs.openclaw.com/) | OpenClaw | 个人 Agent 搭建指南 |
