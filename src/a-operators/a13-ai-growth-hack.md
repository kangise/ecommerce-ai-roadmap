...
<自检>
① 每个请求的交付物（Hour 1-2: AI 生成 Listing 文案…）都实际给出，未遗漏。 <!-- ref: amazon.bullet_point.count -->
...
<自检>
① 请求的 8 项（你是一个电商转化率优化专家。…）全部出现，编号与顺序和请求一致，无缺项无多余项。 <!-- ref: amazon.bullet_point.count -->
...
<自检>
① 请求的 8 项（你是一个多语言电商本地化专家。…）全部出现，编号与顺序和请求一致，无缺项无多余项。 <!-- ref: amazon.bullet_point.count -->
