...
> 越境ECのための決定版 AI プレイブック — Amazon セラー AI ツール、リスティング最適化、広告運用、TikTok Shop、Shopify、マルチプラットフォーム戦略
...
以下のプロンプトを [ChatGPT](https://chat.openai.com/) または [Claude](https://claude.ai/) にコピーして、即座に市場分析を取得しましょう：

```
あなたは越境ECの上級運営エキスパートで、Amazonプラットフォームに精通しています。
Amazon USでポータブルネックファン（Neck Fan）を販売したいと考えています。
以下を含む簡易的な市場実現可能性分析を行ってください：
1. このカテゴリーの市場特性（季節性、競争度、価格帯）
2. TOP 3 競合の主要セールスポイントと低評価レビューの主なペインポイント
3. 3つの差別化の方向性
4. リスク警告（コンプライアンス、特許、季節性在庫リスク）
主要データの比較は表形式で提示してください。
```

👆 30秒で市場分析が得られます。その他のプロンプト → [プロンプトテンプレート集](../prompts/)
...
- [🆕 最新情報](#-最新情報)
- [人気コンテンツ早見表（48シナリオ）](#人気コンテンツ早見表)
- [学習パスを選ぶ](#学習パスを選ぶ)
- [Path A: 運営担当者 — AI 業務効率化実践](#path-a-運営担当者--ai-業務効率化実践)
- [Path B: 技術者 — AI システム構築](#path-b-技術者--ai-システム構築)
- [Path C: マネージャー — AI 戦略実行](#path-c-マネージャー--ai-戦略実行)
- [プロンプトテンプレート集](#プロンプトテンプレート集)
- [Notebook ラボ](#notebook-ラボ)
- [学習進捗トラッカー](#学習進捗トラッカー)
- [AAAI China Chapter コミュニティ](#aaai-china-chapter-コミュニティ)
